...
@Component({
  selector: 'app-select-folderoptions-modal',
  templateUrl: './select-folderoptions-modal.page.html',
  styleUrls: ['./select-folderoptions-modal.page.scss'],
})
export class SelectFolderoptionsModalPage implements OnInit {
