...
@Component({
  selector: 'app-select-advertisementoptions-modal',
  templateUrl: './select-advertisementoptions-modal.page.html',
  styleUrls: ['./select-advertisementoptions-modal.page.scss'],
})
export class SelectAdvertisementoptionsModalPage implements OnInit {
