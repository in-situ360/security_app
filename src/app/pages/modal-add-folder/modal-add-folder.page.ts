...
@Component({
  ...
  templateUrl: './modal-add-folder.page.html',
  styleUrls: ['./modal-add-folder.page.scss'],
})
export class ModalAddFolderPage implements OnInit {
  ...
  public async submitForm(): Promise<void> {
    ...
    this.apiService.createNewFolder(this.form.value).subscribe(async (result) => {
      if (result['state'] == 'CREATED') {
        
        //HACER UN CHANGE
        this.apiService.folderChanges.next({ type: 'create',folder:result['actuProject']});
      ...
      this.createNewFirstLevelFolder();
  ...
  createNewFirstLevelFolder(){

    this.isChargeLoading=true;
    this.apiService.createNewFirstLevelFolder(this.form.value).subscribe(async (result) => {
      if (result['state'] == 'CREATED') {
