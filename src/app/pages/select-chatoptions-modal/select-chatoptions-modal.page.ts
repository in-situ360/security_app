...
@Component({
  selector: 'app-select-chatoptions-modal',
  templateUrl: './select-chatoptions-modal.page.html',
  styleUrls: ['./select-chatoptions-modal.page.scss'],
})
export class SelectChatoptionsModalPage implements OnInit {
