...
@Component({
  selector: 'app-all-image-cropper',
  templateUrl: './all-image-cropper.page.html',
  styleUrls: ['./all-image-cropper.page.scss'],
})
export class AllImageCropperPage implements AfterViewInit  {
...
async saveCroppedImage() {
  ...
  try {
    ...
    const result = await this.apiService.multimediaCroppedEdit(formData).toPromise();
