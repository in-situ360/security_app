...
@Component({
  selector: 'app-modal-menu-folder',
  templateUrl: './modal-menu-folder.page.html',
  styleUrls: ['./modal-menu-folder.page.scss'],
})
export class ModalMenuFolderPage implements OnInit {
    ...
    if($opc==3){
      this.abrirModalAddFolder();
       ...
       // this.apiService.linkAddChange.next(['title','value']);
        ...
        this.apiService.mediaActivatedFolder.next();
