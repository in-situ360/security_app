...
@Component({
  selector: 'app-app-pgchat-footer',
  templateUrl: './app-pgchat-footer.component.html',
  styleUrls: ['./app-pgchat-footer.component.scss'],
})
export class AppPgchatFooterComponent implements OnInit {
  ...
  public adjuntarArchivo() {
    ...
    if(this.mostrarAudio){
      this.utilities.showToast(this.translate.instant('app-pgchat-footer.Se está realizando una grabación de audio'));
      return;

    }
    else if(this.audioBase64!=null){

      this.utilities.showToast(this.translate.instant('app-pgchat-footer.Hay un archivo de audio pendiente para enviar'));
      return;
    ...
    fileInput.addEventListener('change', async (event) => {
        ...
        if (selectedFile) {
            ...
            if (selectedFile.type !== 'application/pdf') {
              this.utilities.showToast(this.translate.instant('app-pgchat-footer.Solo se permiten archivos .pdf'));
  ...
  async iniciarGrabacion() {
    if(this.mostrarAudio==false){
      ...
      this.utilities.showToast(this.translate.instant('app-pgchat-footer.Ya hay una grabación en proceso'));
    }
  }
