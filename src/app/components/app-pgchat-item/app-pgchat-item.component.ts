...
@Component({
  selector: 'app-app-pgchat-item',
  templateUrl: './app-pgchat-item.component.html',
  styleUrls: ['./app-pgchat-item.component.scss'],
})
export class AppPgchatItemComponent implements OnInit {
    ...
    if(this.pdfdata!=null){
      console.log('pdfdata!=null');
        if(this.pdfbase64!=null){
          ...
          console.log(this.id);
        this.apiService.obtainPGMessage({ id: this.id }).subscribe((result) => {
